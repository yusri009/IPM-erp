...
function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-zinc-200/60 bg-white/80 dark:border-zinc-800/60 dark:bg-zinc-950/80 backdrop-blur-xl">
      {/* Logo */}
      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        ...
        <NavLink to="/cheques" className={navLinkClass}>
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="ml-64 flex-1 p-8 pt-20">
        {/* Top Header */}
        <div className="fixed top-0 right-0 left-64 h-16 flex items-center justify-end px-8 z-30 bg-gradient-to-b from-[var(--color-bg-start)] to-transparent pointer-events-none">
          <div className="flex items-center gap-6 animate-fade-in-up pointer-events-auto">
            {/* Notifications */}
            <button
